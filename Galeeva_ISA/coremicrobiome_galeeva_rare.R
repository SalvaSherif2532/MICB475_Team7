...
nonsevere_rare_ASVs <- core_members(galeeva_rare_nonsevere, detection=0.001, prevalence = 0.7)
severe_rare_ASVs <- core_members(galeeva_rare_severe, detection=0.001, prevalence = 0.7)
